...
impl<'a> Renderer<'a> {
    ...
    pub fn draw(&mut self, window: &Window) -> Result<(), wgpu::SurfaceError> {
        ...
        // main rendering
        self.render_main_pass(&view, &mut encoder);

        // egui rendering
        self.render_egui_pass(window, &view, &mut encoder);
    ...
    fn render_main_pass(&mut self, view: &TextureView, encoder: &mut CommandEncoder) {
    ...
    fn render_egui_pass(
        ...
        let usd_time_code = &mut self.usd_time_code;
        ...
        let full_output = self.egui_context.run(raw_input, |ui| {
            egui::Window::new("Control Panel").show(ui, |ui| {
                ...
                ui.scope(|ui| {
                    ...
                    ui.horizontal(|ui| {
                        ui.label("Time Code: ");
                        ui.add(egui::Slider::new(usd_time_code, 0..=109));
                    });
                });
            });
        });
